...
<div class="background-deep doikhang">
</div>
<div class = "head-title">
	<p>Đối kháng</p>
	<p style="font-size: 30px">Chiến đấu để sống sót</p>
	<div class="go">
...
<div class="container">
	<div class="hover-effect">
		...
		<div class="row">
		<?php 
			$sql = "select product_id from product, category where product.category_id = category.category_id and short_name='bansung'"; 
