							...
							<div class="my-order-item">
								...
								if (isset($_SESSION['cart'])) {
									...
									while ($row = mysqli_fetch_array ($result)) {
										...
										?>
										<div class="media" >
											<img width="40%" src="<?=$row["product_image"]?>" alt="">
											<div class="info-product">
												<p class="font-large">Thông tin sản phẩm</p>
												<span class="color-gray my-order-info"><b>Tên đĩa:</b> <?=$row["product_name"]?></span>
												<span class="color-gray my-order-info"><b>Giá:</b> <?=$row["price_buy"]?></span>
												<span class="color-gray my-order-info"><b>Số lượng:</b><?=$_SESSION['cart'][$row["product_id"]]?></span>
											</div>
										</div>
