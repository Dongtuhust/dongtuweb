...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th5 06, 2018 lúc 06:23 PM
...
(558525, 'SAD', 'saD', 2147483647, 3300000, '2018-05-03 09:51:50', 'COD', 'Nam', 'ÁDASD', 'Đang chờ'),
...
(265996, 'Dongtu', 'Couter Stricke', 800000, 'Nguyễn Đông Tư', 'Nam', '29 Khương Hạ', 1649361661, '2018-05-06 22:13:19', 'COD', '', 'Đang chờ');
...
(5, 'Resident Evil 7', 1300000, 'Tiếp theo Resident Evil 5 và Resident Evil 6 , Resident Evil 7 sẽ trở lại với rễ kinh dị sống còn của franchise, với sự nhấn mạnh về thăm dò', '../image/img5.jpg', '../image/img5', 5, 'WB Games', 144, 'Mới', '0000-00-00'),
(6, 'The Division', 700000, 'Bộ phận The DivisionTM của Tom Clancy là một trải nghiệm RPG thực tế khiến cho thể loại này trở thành một thiết lập quân sự hiện đại lần đầu tiên.', '../image/img6.jpg', '../image/img6', 4, 'Rare', 175, 'Mới', '0000-00-00'),
...
(1, 'Couter Stricke', 800000, 300000, 'Tựa game bắn súng cực hót cho ae , mình mới mua đầu tết vẫn còn mới nguyên hộp còn bảo hành đến tháng 2/2019 ', '../image/img1.jpg', 'Bắn súng', 'dongtu.hust@gmail.com', '96%', 'Đã bán'),
...
(12, 'Let It Die', 800000, 500000, 'Chiến đấu để đạt được vị trí cao nhất trong hành động sống còn hỗn loạn và bong bóng này đang diễn ra tự do để chơi đến một cấp độ hoàn toàn mới. Bắt đầu cuộc hành trình của bạn trong bộ đồ lót của bạn và sống sót bằng bất kỳ phương tiện cần thiết trong khi tham khảo ý kiến ​​từ Chú chim, một máy gặt ván trượt', '../image/img12.jpg', 'Kinh dị', 'haihoang@gmail.com', '79%', NULL),
(15, 'Far Cry 5', 900000, 300000, 'Far Cry 5 ra đời được 6 năm nhưng độ hot của nó vẫn k hề xuyên giảm giá cực tốt cho ae lấy ngay , giá thị trường 1tr3 bán lại cho ae 900k hình thức hơi xước nhẹ nhưng chơi k hề bị vấp ', '../image/product_user/farcry.jpg', 'Phiêu lưu', 'dongtu.hust@gmail.com', '86%', NULL),
(16, 'Bio Shock ', 700000, 300000, 'Bio Sock giá mua cũ 700k giá thuê 300k/tuần hình thức vẫn còn mới', '../image/product_user/bioshock.jpg', 'Nhập vai', 'dongtu.hust@gmail.com', '95%', NULL);
...
(22, 'DucHuy97', 'anhlaso1', 'duchuy@gmail.com', '2018-05-03 17:15:14', 0, 0, 'Nghệ An', 2147483647);
...
--
ALTER TABLE `order_customer`
  MODIFY `order_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=874694;
